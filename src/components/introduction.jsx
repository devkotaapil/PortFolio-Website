...
const Introduction = () => {
  return (
    <section className="grid grid-cols-1 gap-6  m-1.5 p-4 md:p-6 lg:grid-cols-2 lg:items-center">
      ...
      <div className="flex justify-center items-center  p-4 rounded-xl bg-muted/10">
        <img
